...
exports.ProcessTest = void 0;
const browser_1 = require("./browser");
const node_fetch_1 = __importDefault(require("node-fetch"));
var ProcessTest;
(function (ProcessTest) {
    class Req {
        static Request(url, info) {
            return __awaiter(this, void 0, void 0, function* () {
                let Response = yield (0, node_fetch_1.default)(url, info);
            });
        }
    }
    ProcessTest.Req = Req;
})(ProcessTest = exports.ProcessTest || (exports.ProcessTest = {}));
test();
function test() {
    return __awaiter(this, void 0, void 0, function* () {
        let StartHref = {
        ...
        let t = yield new browser_1.chrome.browser(exampleScript, exampleConfig);
        yield t.Start();
